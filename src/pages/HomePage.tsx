  ...
  return (
    <div className="min-h-screen bg-slate-950 text-slate-50 flex flex-col items-center justify-center p-4">
      <div className="max-w-md w-full bg-slate-900 border border-slate-800 rounded-xl shadow-2xl p-8 text-center">
        <img src={`${import.meta.env.BASE_URL}taekwondo-logo.png`} alt="شعار نظام التايكوندو" className="mx-auto mb-5 h-24 w-24 rounded-3xl border border-blue-300/20 object-cover shadow-xl" />
        <h1 className="text-3xl font-bold tracking-tight mb-2">نظام تسجيل النقاط</h1>
